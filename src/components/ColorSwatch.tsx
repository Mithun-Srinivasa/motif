...
export default function ColorSwatch({ swatch, size = 'lg' }: ColorSwatchProps) {
  ...
  return (
    <div className="flex-1 min-w-0 overflow-hidden" style={{ borderRadius: '4px' }}>
      ...
      {/* Info block */}
      <div className="p-3" style={{ background: '#f5f1ea' }}>
        <p style={{ color: '#1c1917', fontSize: '12px', fontWeight: 500, fontFamily: 'DM Sans, sans-serif', marginBottom: '2px' }}>
          {name}
        </p>
        <p style={{ color: '#78716c', fontSize: '11px', fontFamily: 'DM Sans, sans-serif', lineHeight: 1.4 }}>
          {emotion}
        </p>
      </div>
    </div>
